...
class LoadIcons {
	...
	public function __construct() {
		...
		add_action( 'wpcfto_enqueue_scripts', [ $this, 'enqueue' ] );

		add_action( 'elementor/icons_manager/additional_tabs', [ $this, 'add_elementor_custom_icons' ], 100, 1 );
		add_action( 'elementor/preview/enqueue_styles', [ $this, 'enqueue' ] );
		add_action( 'elementor/editor/before_enqueue_styles', [ $this, 'enqueue' ] );

		add_filter( 'init', [ $this, 'add_vc_font_set' ], 40 );
		add_filter( 'vc_after_init', [ $this, 'add_vc_font_picker' ], 40 );
		add_filter( 'vc_iconpicker-type-customicons', [ $this, 'add_vc_custom_icons' ] );
	 ...
	 * @return array
	 */
	public function add_elementor_custom_icons( $tabs = [] ) {
		$new_icons      = [];
