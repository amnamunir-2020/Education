...
final class Consulting_Elementor_Widgets
{
    ...
    public function include_widgets()
    {
        ...
        require_once(__DIR__ . '/widgets/header/contact_info.php');
        require_once(__DIR__ . '/widgets/header/icon_box.php');
        require_once(__DIR__ . '/widgets/header/logo.php');
        require_once(__DIR__ . '/widgets/header/menu.php');
        require_once(__DIR__ . '/widgets/header/search.php');
        require_once(__DIR__ . '/widgets/header/wpml.php');
        require_once(__DIR__ . '/widgets/about_vacancy.php');
        require_once(__DIR__ . '/widgets/anchors_link.php');
        require_once(__DIR__ . '/widgets/anchors_text.php');
        ...
        require_once(__DIR__ . '/widgets/iconboxes_with_tabs.php');
