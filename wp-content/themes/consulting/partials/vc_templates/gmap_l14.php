                ...
                <div class="col-md-6 col-sm-6">
                    <div class="addresses">
                        ...
                        <?php foreach($addresses as $key_add => $address): ?>
                            <div
                                    class="single-loc"
                                    data-country="<?php echo esc_attr($address['offices']['0']['country']) ?>"
                                    data-title="<?php echo esc_attr($address['offices']['0']['title']) ?>"
                                    data-lat="<?php echo esc_attr($address['offices']['0']['lat']) ?>"
                                    data-lng="<?php echo esc_attr($address['offices']['0']['lng']) ?>"
                            ></div>
                        <?php endforeach; ?>
                        <div class="row">
