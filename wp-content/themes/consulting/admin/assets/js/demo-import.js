    ...
    jQuery(document).ready(function () {
        ...
        jQuery('input[name="builder"]').on('change', function() {
            ...
            if (jQuery(this).val() == "elementor") {
                jQuery('.elementor-layout').addClass('elementor-layout-active');
            } else {
                jQuery('.elementor-layout').removeClass('elementor-layout-active');
            }
        });
